...
TEST(TestSuitePlayingCards, TestStandardCardsDeck) {
    ...
    using Deck32 = pltr::cards::StandardCardsDeck<CardFr, 32, START_VALUE_32, START_ORDERING_VALUE_32>;
    ...
    pltr::cards::StandardCardsDeck<CardFr, 54, START_VALUE_54, 0, N> deck543;
